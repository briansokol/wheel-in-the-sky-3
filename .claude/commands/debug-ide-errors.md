...
Use the typescript-error-analyzer agent to analyze and resolve all TypeScript type errors, Oxlint warnings, and other IDE diagnostics in the current file. To analyze diagnostics across the entire codebase, explicitly specify "analyze all files".
...
2. **Oxlint/Linting Warnings**: Code quality issues, pattern violations, or style inconsistencies
...
- Clear categorization of errors by type (TypeScript, Oxlint, etc.)
